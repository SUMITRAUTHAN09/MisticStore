      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-12">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2
                className={`${mehkaoFont.className} text-xl md:text-2xl tracking-[0.22em] bg-gradient-to-r from-yellow-300 via-yellow-400 to-orange-400 bg-clip-text text-transparent uppercase drop-shadow-[0_0_8px_rgba(255,180,60,0.35)]`}
              >
                MEHKAO
              </h2>
          ...
          <p className="text-zinc-500 text-sm leading-relaxed font-sans">
            Premium Dhoop & Agarbatti crafted with devotion, purity and timeless
            tradition.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <a
              href="tel:+919208137401"
              className="flex items-center gap-3 text-sm text-zinc-400 hover:text-yellow-400 transition duration-300 font-sans group"
            >
...
function FooterLink({
  ...
  return (
    <Link
      href={href}
      className="text-sm font-sans text-zinc-400 hover:text-yellow-400 transition duration-300 tracking-wide"
    >
      {children}
    </Link>
  );
